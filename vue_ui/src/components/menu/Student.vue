<template>
  <div class="common">
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <router-link tag="a" to="/student/home" class="nav-link">Home</router-link>
        </li>
        <!--<li class="nav-item d-none d-sm-inline-block">-->
          ...
          >
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <router-link tag="li" to="/student/otp" class="nav-item">
                  <a class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>群聊</p>
                  </a>
                </router-link>
                <router-link tag="li" to="/student/oto" class="nav-item">
                  <a class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>私聊</p>
                  </a>
    ...
    <footer class="main-footer">
      <strong>
        @GUO
        <a href="http://blog.stilling.cn/">个人博客</a>.
      </strong>
...
export default {
  ...
  methods: {
    outlogin() {
      window.location.href = "http://localhost:8880/#/Login";
    }
  }
};
</script>
