                ...
                success:(result)=>{
                 if (result=="用户名或者账号输入错误"){
                    ...
                    //  window.localStorage.setItem("id",id);
                     if (this.radio3==1)  window.location.href=' http://localhost:8880/#/admin/home'
                     if (this.radio3==2)  window.location.href=' http://localhost:8880/#/student/home'
                     if (this.radio3==3)  window.location.href=' http://localhost:8880/#/teacher/home'
                 }
                }
            })
